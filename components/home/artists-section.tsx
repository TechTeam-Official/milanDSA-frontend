      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-20 space-y-4">
          ...
          <motion.p
            ...
            Big voices. Crazy performances. Non-stop music, memories, and magic.
            Where campus energy meets culture.
          </motion.p>
        </div>
            ...
            .map((person, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className={`relative group rounded-3xl overflow-hidden bg-[#FFFFF0] border border-[#C9A24D] shadow-lg hover:shadow-2xl transition-all duration-500 ${
                    isLarge
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 translate-y-2 group-hover:translate-y-0 transition-transform duration-500 z-30">
                    <div className="bg-[#FFFFF0]/90 backdrop-blur-sm border border-[#C9A24D]/30 p-4 rounded-xl shadow-lg transform translate-y-full group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-500 ease-out flex flex-col justify-between h-full max-h-[140px]">
                      <div>
                        <h3
                          className={`font-bold text-[#3B2D5F] leading-tight break-words ${isLarge ? "text-3xl" : "text-lg"}`}>
                          {person?.name}
                        </h3>
