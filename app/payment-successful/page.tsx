      ...
      >
        ...
        <div className="flex flex-col gap-4">
            <Button 
                ...
                className="h-16 w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 text-white rounded-2xl font-bold text-lg shadow-lg shadow-green-900/20 transition-all hover:scale-[1.02]"
            >
                View My Passes
            </Button>
        </div>
